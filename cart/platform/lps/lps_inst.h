/* lps_inst.h -- GENERATED by tools/lps_romscan.py. Do not edit.
 *
 ...
 * sound, and where the drum kit's slots are. Regenerate with:
 *
 *     python3 tools/lps_romscan.py <sound-rom>
 *
 * Instrument NAMES are not in the ROM. The LPS_PROG_* constants below are
 * provisional -- what earlier projects wrote down by ear, conflicts and all.
 *
 ...
 * monophonic. That is the trap: programs 64 and 105 are both long-standing
 * favourites and both layered.
 */
 ...
 *
 * Several earlier projects used two notes from the same zone believing they
 * were different drums. They were not.
 */
...
/* ---- Provisional instrument names --------------------------------------
 *
 * Not from the ROM. These are prior projects' by-ear identifications, and
 * where they disagree the disagreement is recorded rather than resolved.
 * Phase 5's audition ROM replaces this block wholesale.
 */
#define LPS_PROG_PIANO          1 /* sopwith: Piano | doom E1M2: harpsichord | doom E1M6: sting layer */
#define LPS_PROG_MUSIC_BOX      2 /* doom E1M6 intro */
#define LPS_PROG_GUITAR         4 /* sopwith: Guitar | doom: distortion guitar */
#define LPS_PROG_ORGAN         16 /* sopwith */
#define LPS_PROG_BASS_19       19 /* doom E1M4 */
#define LPS_PROG_BASS_41       41 /* doom E1M6 */
#define LPS_PROG_BRASS         64 /* sopwith: Brass | doom: brass/saw -- LAYERED */
#define LPS_PROG_BASS          87 /* sopwith: Bass | doom: synth bass ostinato */
#define LPS_PROG_BOWED_PAD     90 /* doom E1M3 lead */
#define LPS_PROG_KALIMBA       96 /* sopwith */
#define LPS_PROG_STRINGS      100 /* doom E1M2/E1M5 -- reported a dead-on SC-55 match */
#define LPS_PROG_SYNTH2       105 /* sopwith: Synth 2 | doom: synth brass -- LAYERED */
#define LPS_PROG_SYNTH        108 /* sopwith: Synth */
